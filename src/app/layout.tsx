...
export default async function RootLayout({
  ...
  return (
    <html lang={locale} className={`${inter.variable} ${playfair.variable}`} suppressHydrationWarning>
      <head>
        <link rel="icon" href="/favicon.ico?v=20260218" sizes="any" />
        <link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png?v=20260218" />
        <link rel="icon" type="image/png" sizes="32x32" href="/favicon-32x32.png?v=20260218" />
        <link rel="icon" type="image/png" sizes="16x16" href="/favicon-16x16.png?v=20260218" />
