...
export default function Highlights() {
  ...
  const items: Item[] = [
    ...
    },
    {
      ...
      icon: Leaf,
      images: [
        { src: '/images/rooms/thumbs/suite-luxo.jpg', alt: 'Suíte Luxo' },
        { src: '/images/rooms/thumbs/Suite-Master-com-sacada-e-vista-para-a-piscina.jpg', alt: 'Suíte Master' },
        { src: '/images/rooms/thumbs/Apartamento-Standard-com-vista-interna.jpg', alt: 'Apartamento Standard' },
        { src: '/images/rooms/thumbs/Apartamento-Standard-frente-rua.jpg', alt: 'Apartamento Standard (frente rua)' },
        { src: '/images/rooms/thumbs/Apartamento-luxo2.jpg', alt: 'Apartamento Luxo' },
        { src: '/images/rooms/thumbs/conjugado.jpg', alt: 'Apto Conjugado' },
        { src: '/images/rooms/thumbs/conjugado2.jpg', alt: 'Apto Conjugado (variação)' },
      ],
    },
  ]
